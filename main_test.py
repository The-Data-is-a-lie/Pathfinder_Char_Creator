...
def generate_random_char(create_new_char='Y', userInput_region=14, userInput_race='human', class_choice='ranger', multi_class='N', alignment_input = 'LE' , userInput_gender='', truly_random_feats = "Y", num_dice=1, num_sides=1, high_level=40, low_level=40, gold_num=1000000):
