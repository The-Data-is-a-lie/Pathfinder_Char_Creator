...
def generate_random_char(create_new_char='Y', userInput_region=14, userInput_race='human', class_choice='arcanist', multi_class='N', alignment_input = 'LE' , userInput_gender='', truly_random_feats = "Y", num_dice=4, num_sides=6, high_level=15, low_level=15, gold_num=1000000):
