...
#need to use archetypes_{class_name} so we can grab it like this later
                    ...
                    #Path of war classes
personality_traits = [
    "Tactile", "Confident", "Polite", "Tolerant", "Witty", "Tolerant", "Curious", "Energetic", "Curious", "Affectionate",
    "Responsible", "Kind-hearted", "Patient", "Adaptable", "Diligent", "Balanced", "Passionate", "Self-aware", "Greedy",
    "Focused", "Adventurous", "Cynical", "Grounded", "Punctual", "Cheerful", "Imaginative", "Polite", "Imaginative",
    "Rational", "Dutiful", "Supportive", "Steady", "Cowardly", "Optimistic", "Understanding", "Friendly", "Scheming",
    "Adventurous", "Flexible", "Quick-witted", "Diplomatic", "Sincere", "Blunt", "Willing", "Calm", "Open-minded", "Wise",
    "Charismatic", "Practical", "Sensitive", "Hot-headed", "Respectful", "Determined", "Gentle", "Nurturing", "Generous",
    "Insecure", "Reliable", "Optimistic", "Cooperative", "Ambitious", "Spontaneous", "Suspicious", "Motivated", "Nonchalant",
    "Inquisitive", "Disciplined", "Inventive", "Modest", "Easily discouraged", "Empathetic", "Focused", "Serious", "Humble",
    "Ambitious", "Considerate", "Patient", "Proud", "Caring", "Helpful", "Generous", "Clear-headed", "Creative", "Self-sufficient",
    "Forgiving", "Vibrant", "Easygoing", "Resourceful", "Determined", "Honest to a fault", "Perceptive", "Imaginative",
    "Supportive", "Intuitive", "Hardworking", "Thoughtful", "Sympathetic", "Nurturing", "Trustworthy", "Honest", "Persevering",
    "Hardworking", "Self-loathing", "Rebellious", "Optimistic", "Strategic", "Mature", "Balanced", "Open-minded", "Assertive",
    "Affectionate", "Relaxed", "Persistent", "Realistic", "Eloquent", "Reliable", "Analytical", "Sociable", "Treacherous",
    "Independent", "Cooperative", "Cruel", "Fair-minded", "Optimistic", "Brave", "Patient", "Creative", "Grateful", "Calm",
    "Arrogant", "Devoted", "Lazy", "Sincere", "Sympathetic", "Lively", "Confident", "Resourceful", "Efficient", "Disciplined",
    "Energetic", "Thoughtful", "Sociable", "Generous", "Idealistic", "Realistic", "Gentle", "Compassionate", "Thoughtful",
    "Reckless", "Persevering", "Charming", "Patient", "Chivalrous", "Empathetic", "Adventurous", "Adventurous", "Loyal", "Loyal",
    "Playful", "Respectful", "Emotional", "Generous", "Stoic", "Balanced", "Genuine", "Steady", "Curious", "Cautious", "Serene",
    "Trusting", "Responsible", "Pragmatic", "Affectionate", "Pragmatic", "Genuine", "Tactful", "Sociable", "Disrespectful",
    "Hardworking", "Homebody", "Witty", "Loyal", "Apathetic", "Kind", "Deceptive", "Playful", "Imaginative", "Observant",
    "Versatile", "Organized", "Reliable", "Wise", "Stubborn", "Altruistic", "Resourceful", "Motivated", "Supportive", "Resilient",
    "Impulsive", "Dependable", "Sensitive", "Self-assured", "Self-reliant", "Self-critical",
    "Self-sufficient", "Self-aware", "Selfless", "Selfish", "Serious", "Skeptical", "Sociable", "Spontaneous", "Supportive",
    "Suspicious", "Sympathetic", "Tactful", "Tolerant", "Trustworthy", "Unselfish", "Vigilant", "Wise", "Witty", "Zealous",
    "Zesty",
    "Support pillar", "Emotionally bright", "Serene mind", "Firestarter", "Imaginative planner", "Warm thinker",
    "Compulsive organizer", "Wise beyond years", "Kind realist", "Mindful thinker", "Gentle humor", "Thoughtful realist",
    "Decisive doer", "Deep thinker", "Empathic listener", "Cool under pressure", "Quietly passionate", "Introverted extrovert",
    "Voice of reason", "Social butterfly", "Playful mind", "Focused creator", "Jack of all trades", "Focused planner",
    "Rational thinker", "Silent strength", "Chill thinker", "Inner fire", "Witty companion", "Lone wolf", "Productive dreamer",
    "Quiet observer", "Silent storm", "Emotionally brave", "Big picture thinker", "Intellectual wanderer", "Skeptical mind",
    "Spontaneous thinker", "Big dreamer", "Driven by curiosity", "In-the-moment type", "Always alert", "Social chameleon",
    "Modest genius", "Habitual helper", "Cautious planner", "Idea machine", "Friendly rival", "Quiet strength", "Level-headed",
    "Quick adapter", "Gentle motivator", "Grounded friend", "Chill realist", "Good listener", "Inner critic", "Storyteller",
    "Improviser", "Risk taker", "Happily focused", "Hard realist", "Mindful helper", "Faithful friend", "Vision-driven",
    "Conscientious thinker", "Solid thinker", "Inspired thinker", "Smiles under stress", "Humble helper", "Emotionally aware",
    "Peaceful planner", "Calculated plotter", "Organized thinker", "Cautiously optimistic", "Respectful debater",
    "Balanced thinker", "Perceptive friend", "Bold but kind", "Faithful companion", "Reserved helper", "Peacekeeper",
    "Always improving", "Authentic self", "Clever negotiator", "Comforting presence", "Playfully smart", "Warm-hearted",
    "Big-hearted", "Instinct-driven", "Persistent pursuer", "Optimistic realist", "Creative planner", "Heartful doer",
    "Artistic soul", "Warm soul", "Resistant to change", "Routine lover", "Harmonizer", "Rational dreamer", "Deep empath",
    "Clear communicator", "Emotional tactician", "Free spirit", "Mentally tough", "Curiously clever", "Organized chaos",
    "Conflict avoider", "Creative realist", "Emotionally expressive", "Genuine leader", "Gentle giant", "Loyal companion",
    "Daily optimist", "Calm observer", "Master of one", "Easily amused", "Emotionally grounded", "Practical dreamer",
    "Emotionally deep", "Hopeful realist", "Logical reasoner", "Extroverted introvert", "Organized idealist", "Cheerful worker",
    "Emotionally steady", "Loves the spotlight", "Life of the party", "Grounded idealist", "Dreamer", "Charmer", "Planner",
    "Spark of joy", "Friendly dreamer", "Gentle challenger", "Calm in crisis", "Rule breaker", "Adaptable spirit", "Enigmatic",
    "Cool analyst", "Problem solver", "Gentle heart", "Harmony seeker", "Quick to learn", "Humble visionary", "Observant one",
    "Natural leader", "Slow to trust", "Resilient heart", "Voice of calm", "Habit maker", "By-the-book", "Occasional worrier",
    "Emotional realist", "Analyzer", "Strong-willed", "Bold strategist", "Creative soul", "Hidden optimist", "Old soul",
    "Kind soul", "Balanced doer", "Innocent soul", "Heart on sleeve", "Fades into background", "High achiever",
    "Thought provoker", "Curious skeptic", "Cautiously bold", "Team player", "Mentally agile", "Cheerful pragmatist",
    "Eager follower", "Encourager", "Strategic dreamer", "Bright spirit", "Fast talker", "Down-to-earth dreamer",
    "Casual philosopher", "Reluctant leader", "Emotionally tuned", "Energetic thinker", "Determined spirit", "Cool-headed",
    "Straight shooter", "Peaceful rebel", "Persistent thinker", "Helpful spirit", "Kind thinker", "Cleverly quiet",
    "Graceful presence", "Assertive voice", "Goal setter", "Moral compass", "Encouraging realist", "Soft-spoken",
    "Attentive spirit", "Always curious", "Warm presence", "Overthinker", 
    "Neatly chaotic",
    "Always on time", "Always optimistic", "Always volunteering", "Assertive critic", "Assertive talker",
    "Awkward debater", "Awkward host", "Big picture thinker", "Big talker", "Blissfully unaware list maker",
    "Blissfully unaware quick thinker", "Blissfully unaware speaker", "Blissfully unaware talker", "Blunt critic",
    "Blunt diplomat", "Blunt force honesty", "Blunt laugher", "Bold dreamer", "Bold planner", "Bold presence",
    "Brilliant companion", "Brilliant rebel", "Careful dreamer", "Careful list maker", "Careful soul",
    "Careful tough love type", "Casual debater", "Casual gut follower", "Casual late arriver", "Casual laugher",
    "Casual planner-in-chief", "Casual rebel", "Casual soul", "Casual truth teller", "Chaotic good",
    "Charismatic speaker", "Charming teammate", "Cheerful dreamer", "Cheerful thinker", "Chronic over-explainer",
    "Chronic realist", "Clever companion", "Clever host", "Clever teammate", "Confident planner-in-chief",
    "Confident tough love type", "Constant hugger", "Constant late arriver", "Constant planner-in-chief",
    "Constant team cheerleader", "Constant tough love type", "Constant vibe checker", "Curious thinker",
    "Daydream believer", "Deeply logical", "Deliberate backseat driver", "Deliberate gut follower",
    "Deliberate teammate", "Deliberate thinker", "Deliberate wise ass", "Detail obsessed", "Drama avoider",
    "Drama magnet", "Driven by late arriver", "Driven by planner", "Driven by quick thinker", "Driven by teammate",
    "Driven by thinker", "Dry humor", "Eloquent jokester", "Empathy machine", "Eternal skeptic",
    "Excellent judge of character", "Expert debater", "Expert hugger", "Expert over-thinker",
    "Expert planner-in-chief", "Expert speaker", "Fashionably late", "Fast quick thinker", "Fast story weaver",
    "Frequent teammate", "Gentle communicator", "Gentle jokester", "Gentle talker", "Gentle teammate",
    "Graceful under pressure", "Hopeless romantic", "Introvert in disguise", "Keen observer",
    "Laughs at own jokes", "Life of the party", "Loud companion", "Loud critic", "Loud planner", "Loud soul",
    "Loud talker", "Loud thinker", "Loud wise ass", "Lover of lists", "Lover of loyal sidekick",
    "Lover of mood reader", "Lover of teammate", "Master of backseat driver", "Master of communicator",
    "Master of critic", "Master of diplomacy", "Master of friend", "Master of judge of character",
    "Master of listener", "Master of small talk", "Master of teammate", "Master planner", "Mellow friend",
    "Natural backseat driver", "Natural friend", "Natural jokester", "Natural talker", "Natural wise ass",
    "Natural-born skeptic", "Naturally curious", "Nervous host", "Nervous talker", "No-nonsense type",
    "Obsessed with critic", "Obsessed with vibe checker", "Occasional quick thinker", "Occasional story weaver",
    "Occasional thinker", "Over-apologizer", "Passive-aggressive charmer", "Phone call hater",
    "Quiet accidental comedian", "Quiet companion", "Quiet diplomat", "Quiet late arriver", "Quiet over-thinker",
    "Quiet tough love type", "Reflective diplomat", "Reflective listener", "Reflective rebel", "Sarcastic planner",
    "Sarcastic talker", "Sarcastic wit", "Self-deprecating comic", "Sharp communicator", "Sharp talker",
    "Sharp tongue, soft heart", "Silent type", "Silent watcher", "Sincerely expressive friend",
    "Sincerely expressive team cheerleader", "Sincerely expressive truth teller", "Skilled communicator",
    "Skilled laugher", "Skilled planner", "Skilled planner-in-chief", "Skilled presence", "Skilled story weaver",
    "Skilled talker", "Skilled tough love type", "Slow over-thinker", "Slow speaker", "Smooth talker",
    "Soft loyal sidekick", "Soft over-thinker", "Soft talker", "Soft teammate", "Soft tough love type",
    "Soft wise ass", "Soft-spoken critic", "Stoic friend", "Stoic host", "Stoic jokester", "Stoic talker",
    "Straight talker", "Strong accidental comedian", "Subtle manipulator", "Sweet diplomat", "Tactful presence",
    "Tactful talker", "Talkative rebel", "Talks with hands", "Thoughtful friend", "Thoughtful rebel",
    "Thoughtful texter", "Thoughtful wise ass", "Unafraid of friend", "Unafraid of jokester",
    "Unafraid of natural skeptic", "Unafraid of non-stop talker", "Unafraid of over-thinker", "Unafraid of story weaver",
    "Unafraid of talker", "Unafraid of thinker", "Wallflower", "Winging it expert", "Wise ass", "Witty diplomat",
    "Witty presence"
