...
,
#
'paladin' : ['Angelfire Apostle', 'Blaze of Glory', 'Champion of the Faith', 'Chosen One', 'Divine Defender', 'Divine Hunter', 'Divine Strategist', 'Divine Warrior', 'Divine Weapon', 'Eagle Knight', 'Empyreal Knight', 'Enlightened Paladin', 'Erastils Boon', 'Holy Gun', 'Holy Tactician', 'Hospitaler', 'Inheritors Crusader', 'Knight of Ozem', 'Knight of the Sepulcher', 'Lion Blade', 'Living Grimoire', 'Oathbound Paladin', 'Oath of Charity', 'Oath of Chivalry', 'Oath of Duty', 'Oath of Loyalty', 'Oath of the Crown', 'Oath of the People', 'Oath of Vengeance', 'Oath against Savagery', 'Oath of Empathy', 'Oath of the Open Hand', 'Sacred Servant', 'Sanctified Prophet', 'Shining Knight', 'Undead Scourge']
,
#
'alchemist': ['Alchemical Trapper', 'Apothecary', 'Beastmorph', 'Blood Alchemist', 'Bombardier', 'Chirurgeon', 'Clone Master', 'Construct Rider', 'Crypt Breaker', 'Ectoplasm Master', 'Elemental Master', 'Experimental Gunsmith', 'Feral Mutagen', 'Frost Rider', 'Grenadier', 'Gunslinger Alchemist', 'Infernal Alchemist', 'Inspired Chemist', 'Master Chymist', 'Mindchemist', 'Mutation Warrior', 'Plague Bringer', 'Psychonaut', 'Reanimator', 'Sapper', 'Soulforger', 'Spagyrist', 'Spelleater', 'Spirit Whisperer', 'Totemic Summoner', 'Twilight Sage', 'Vivisectionist']
#
,
'monk': ['Black Asp', 'Chained Monk', 'Drunken Master', 'Flowing Monk', 'Gong-Fu Disciple', 'Hamatula Strike Monk', 'Hungry Ghost Monk', 'Iron Mountain', 'Ki Mystic', 'Ki Warrior', 'Lotus Geisha', 'Martial Artist', 'Master of Many Styles', 'Monk of the Four Winds', 'Monk of the Healing Hand', 'Monk of the Iron Mountain', 'Monk of the Lotus', 'Monk of the Mantis', 'Monk of the Sacred Mountain', 'Monk of the Seven Winds', 'Monk of the Silver Fist', 'Monk of the Third Eye', 'Mute Monk', 'Nagaji Sensei', 'Nornkith', 'Ouat Monk', 'Sacred Fist', 'Scaled Fist', 'Sensei', 'Sohei', 'Soothsayer', 'Soulknife Monk', 'Swordmaster', 'Tattooed Monk', 'Teisatsu', 'Thunderstriker', 'Unchained Monk', 'Weapon Adept']
#
,
'magus': ["Bladebound", "Eldritch Archer", "Hexcrafter", "Kensai", "Myrmidarch", "Staff Magus"]
#
,
'wizard': ['Arcane Bomber', 'Bladesinger', 'Chronomancer', 'Diviner', 'Elemental Master', 'Foresightful', 'Illusionist', 'Infernal Binder', 'Magical Child', 'Martial Mage', 'Necromancer', 'Occultist', 'Shadowcaster', 'Spell Sage', 'Summoner', 'Thassilonian Specialist', 'Scroll Scholar', 'Spellbinder', 'Spirit Binder', 'Spirit Whisperer', 'Spontaneous Mage', 'Teleportation Master', 'Thaumaturge', 'Universalist', 'Undead Master']
#
,
'sorceror': ['Abyssal Bloodline', 'Accursed', 'Ardent', 'Boreal', 'Brutal', 'Celestial Bloodline', 'Chaos', 'Crossblooded', 'Daemon', 'Djinni', 'Draconic Bloodline', 'Dreamspun', 'Efreeti', 'Elemental Bloodline', 'Empyreal Bloodline', 'Fey Bloodline', 'Ghoul', 'Harrowing', 'Imperious', 'Infernal Bloodline', 'Marid', 'Maestro', 'Psychic Bloodline', 'Rakshasa', 'Razmiran Priest', 'Sanguine', 'Serpentine', 'Shadow', 'Shaitan', 'Stormborn', 'Undead Bloodline', 'Verdant', 'Wildblooded']
#
,
'anti-paladin': ['Apostate', 'Atheist', 'Beast Lord', 'Blacker of the Blackest Black', 'Blackguard', 'Brutal Fiend', 'Chosen One', 'Conqueror', 'Cowled Rider', 'Crimson Templar', 'Cult Slayer', 'Deathtouched', 'Demagogue', 'Demoniac', 'Demonic Champion', 'Demonologist', 'Devil Eater', 'Devils Arm', 'Disciple of Whispers', 'Dread Vanguard', 'Drow Nobility', 'Duellist', 'Executioner', 'Fell Rider', 'Fiend Keeper', 'Fiendish Vessel', 'Glorifier', 'Green Faith Acolyte', 'Hell Knight', 'Hells Vengeance Commander', 'Herald of the Horned King', 'Horseman of the Apocalypse', 'Houndlord', 'Hungerseed', 'Hunter of the Dead', 'Insinuator', 'Knight of the Sepulcher', 'Knight of the Wastes', 'Knight of the Word', 'Martial Disciple', 'Master of Shrouds', 'Night Terror', 'Order of the Ebon Hand', 'Plaguebearer', 'Psychic Beacon', 'Reaper of Vengeance', 'Redeemer', 'Reliquarian', 'Ruin Delver', 'Sanguine Angel', 'Sanguine Disciple', 'Savage Barbarian', 'Seductive Whisperer', 'Senghorian Defender', 'Shadow Disciple', 'Skeletal Champion', 'Soul Flayer', 'Sword Scion', 'Terror Knight', 'Thrune Agent', 'Tyrant', 'Unbreakable Guardian', 'Undead Scourge', 'Unforgiving Zealot', 'Unholy Barrister', 'Unholy Vindicator', 'Warrior of the Holy Light', 'Whispering Wayfinder', 'Widowmaker']
#
,
'cavalier': ['Beast Rider', 'Bushi', 'Castellan', 'Chevalier', 'Constable', 'Daring Champion', 'Disciple of the Pike', 'Divine Commander', 'Emissary', 'Esquire', 'Fell Rider', 'Gendarme', 'Goblin Cleaver', 'Green Knight', 'Herald', 'Honor Guard', 'Huntmaster', 'Knight of the Wall', 'Luring Cavalier', 'Musketeer', 'Order of the Blossom', 'Order of the Cockatrice', 'Order of the Dragon', 'Order of the Eclipse', 'Order of the Flame', 'Order of the Lion', 'Order of the Penitent', 'Order of the Shield', 'Order of the Staff', 'Order of the Star', 'Order of the Sword', 'Order of the Tome', 'Order of the Wall', 'Pure Legionnaire', 'Quarterback', 'Samurai', 'Standard Bearer', 'Tactician', 'Thunderstriker', 'Vengeful Knight']
#
,
'gunslinger': ['Bolt Ace', 'Breaker', 'Bushwacker', 'Chronicler', 'Desperado', 'Dragoon', 'Firebrand', 'Grenadier', 'Gun Scavenger', 'Gun Tank', 'Mysterious Stranger', 'Musket Master', 'Nimble Shot', 'Pistolero', 'Pistolero Exemplar', 'Pirate', 'Rocketslinger', 'Sniper', 'Thunderstriker', 'Vigilante']
#
,
'inquisitor': ['Conversion Inquisitor', 'Daemon Slayer', 'Ecclesitheurge', 'Exorcist', 'Forensic Physician', 'Heretic', 'Infiltrator', 'Inheritors Crusader', 'Judgmental Crusader', 'Monster Tactician', 'Preacher', 'Prepared Inquisitor', 'Sacred Huntmaster', 'Sanctified Prophet', 'Sin Seeker', 'Spellbreaker', 'Witch Hunter', 'Agent of the Grave', 'Divine Assessor', 'Enlightened Paladin', 'Living Grimoire', 'Tactical Leader', 'Umbral Agent', 'Spellkiller', 'Threatener']#
,
'oracle': ['Ancient Lorekeeper', 'Black-Blooded Oracle', 'Blighted Myrmidon', 'Bones Oracle', 'Chosen One', 'Dark Tapestry', 'Dual-Cursed Oracle', 'Elemental Master', 'Enlightened Philosopher', 'Haunted', 'Heavens', 'Hedge Witch', 'Lunar', 'Nature Oracle', 'Noble Scion', 'Outer Rifts', 'Planar Oracle', 'Possessed', 'Seer', 'Shadow Oracle', 'Spirit Guide', 'Stone Tell', 'Time Oracle', 'Visionary Prophet', 'Waves Oracle']
#
,
'shifter': ['Adaptive Shifter', 'Beastkin Berserker', 'Chaos Shifter', 'Cliffwalker Keeper', 'Doppelganger Shifter', 'Dreamstalker', 'Elemental Acolyte', 'Feral Hunter', 'Giant Shifter', 'Lycanthropic Investigator', 'Moonlight Stalker', 'Oozemorph', 'Pack Lord', 'Rageshaper', 'Razorclaw Shifter', 'Saurian Champion', 'Savage Assailant', 'Serpent-Fire Adept', 'Serpentine Bloodline', 'Skinchanger', 'Soul Carver', 'Spellslinger', 'Survivor', 'Tauric Shifter', 'Totem Beast', 'Umbral Blade', 'Verdant Shifter', 'Voidfrost Weaver', 'Watersinger']
#
,
'summoner': ['Broodmaster', 'Chthonic Companion', 'Demonic Apostle', 'Ectopic Summoner', 'Elemental Master', 'Gadget Summoner', 'God Caller', 'Harrower', 'Hedge Witch', 'Malconvoker', 'Master Summoner', 'Occultist Summoner', 'Possessed Hand', 'Psychic Summoner', 'Sanguine Angel', 'Soulbound Puppeteer', 'Spirit Summoner', 'Stargazer', 'Synthesist', 'Undead Lord', 'Unlettered Arcanist', 'Void Caller', 'Wild Caller']
#
,
'witch': ['Bouda', 'Cartomancer', 'Changeling', 'Child of the Briar', 'Demoniac', 'Elementalist', 'Familiar Adept', 'Fey Caller', 'Gutter Mage', 'Hedge Witch', 'Hex Channeler', 'Magical Child', 'Moon Touched', 'Natural Alchemist', 'Patron Witch', 'Pipehedge Necromancer', 'Sea Witch', 'Silksworn', 'Spirit Binder', 'Spitfire', 'Time Thief', 'Valkyrie', 'Veiled Illusionist', 'Venomfist Adept', 'Witchwarden']
#
,
'arcanist': ['Blade Adept', 'Brown-Fur Transmuter', 'Chained', 'Consort', 'Dimensional Occultist', 'Eldritch Font', 'Elemental Master', 'Empyreal', 'False Priest', 'Harrowed Society Mind', 'Occultist', 'Pact Wizard', 'School Savant', 'Scroll Scoundrel', 'Spell Specialist', 'Spirit Binder', 'Twilight Sage']
#
,
'bloodrager': ['Crossblooded Rager', 'Draconic Bloodrager', 'Elemental Bloodrager', 'Hateful Rager', 'Id Rager', 'Metamagic Rager', 'Primalist', 'Spelleater', 'Steelblood']
#
,
'brawler': ['Battle Dancer', 'Bitter-End Enforcer', 'Boxer', 'Brawler Champion', 'Champion of the Cascade', 'Chirurgeon', 'Clumsy Combatant', 'Cornugon Smash', 'Drunken Brawler', 'Exemplar', 'Falconer', 'Feral Combat Training', 'Free-Style Fighter', 'Grapple Fighter', 'Knockout Artist', 'Martial Artist', 'Mutagenic Mauler', 'Pit Fighter', 'Practiced Tactician', 'Savage Technologist', 'Shield Champion', 'Strangler', 'Strangler of the Occult', 'Street Performer', 'Thunderstriker', 'Torturer', 'Unarmed Fighter', 'Wild Child', 'Winding Path Renegade']
#
,
'hunter': ["Divine Hunter", "Feykiller", "Forester", "Frost Rider", "Gendarme", "Geomancer", "Gloomblade", "Hooded Champion", "Horse Lord", "Infiltrator", "Master of the Wild", "Packmaster", "Planar Hunter", "Reclaimer", "Savage", "Sea Singer", "Spire Defender", "Spirit Channeler", "Spirit Whisperer", "Totemic", "Umbral Stalker", "Veiled Illusionist", "Wild Whisperer"]
#
,
'investigator': ["Empiricist", "Exarch", "Forensic Physician", "Infiltrator", "Lamplighter", "Mastermind", "Questioner", "Sleuth", "Spiritualist Investigator", "Symbiotic Investigator", "Synergist", "Unbreakable Survivor", "Virtuoso Sleuth"]
#
,
'shaman': ["Apothecary", "Chaos Spirit", "Dark Tapestry", "Elemental Ally", "Flamespeaker", "Life Spirit", "Lore Oracle", "Nature Spirit", "Stone Spirit", "Waves Spirit", "Witch Doctor", "Woodsman"]
#
,
'swashbuckler': ['Acrobat', 'Buccaneer', 'Daring Infiltrator', 'Daring Champion', 'Flying Blade', 'Inspired Blade', 'Musketeer', 'Mysterious Avenger', 'Picaroon', 'Rondelero duelist', 'Roughrider', 'Serpent Blade', 'Swashbuckler of the Society', 'Vanguard']
#
,
'warpriest': ['Arsenal Chaplain', 'Cloistered Cleric', 'Cult Leader', 'Divine Commander', 'Divine Disciple', 'Divine Paragon', 'Divine Strategist', 'Holy Vindicator', 'Iron Priest', 'Sacred Fist', 'Sacred Shield', 'Sacred Sentinel', 'Sanctified Prophet', 'Shielded Fighter', 'Tactical Leader', 'Weapon Adept']
#
,
#Path of War Archetypes:

'harbringer': ['Crimson Countess','Omen Rider','Ravenlord']
,
#
'mystic': ['Aurora Soul','Gunsmoke Mystic','Knight-Chandler']
,
#
"Stalker": ["Brutal Slayer","Judge","Soul Hunter","Vigilante"]
#
,
'warder': ['Dervish Defender','Fiendbound Marauder','Hawkguard','Ordained Defender','Sworn Protector','Zweihander Sentinel']
#
,
"Warlord": ["Bannerman","Desperado","Steelfist Commando","Vanguard Commander"]
#
,
"Zealot": ["Discordant Crusader","Void Prophet"]
,
# Spheres of might Archetypes:
'armiger': ["Antiquarian", "Awakener", "Battlefield Tinker", "Bladewalker", "Bounty Hunter", "Machinehead", "Stancemaster"]
#
,
'blacksmith': ['Barista [Apoc]', 'Disciple of Goibniu', 'Essence Smith [Apoc, CS]', 'Fleshforger', 'Iron Chef', 'Master-At-Arms [3PP]', 'Spellforge [CS]', 'Techsmith']
#
,
'commander':["Bearon [CS]", "Braveheart", "Dreadlord [CS]", "Feylord [CS]", "Noble", "Vanguard", "Visionary General [CS]"]
#
,
...
#
,
'scholar': ["Astrologian [CS]", "Caller [CS]", "Doctor", "Fell Archaeologist", "Harmacist", "Slime Savant", "Stitcher [CS]"]
#
,
'sentinel': ["Barfighter", "Black Powder Brawler", "Chaos Shifter", "Elemental Fist [CS]", "Shadowed Fist", "Skirmishing Scout", "Strong Style Grappler"]
#
,
'striker': ["Barfighter", "Black Powder Brawler", "Chaos Shifter", "Elemental Fist [CS]", "Shadowed Fist", "Skirmishing Scout", "Strong Style Grappler"]
#
,
'technician': ["Adamantine Scientist", "Mad Scientist", "Mythbreaker", "Rigger", "Suit Pilots"]
#
,
...
#
,
'elementalist':["Admixture Savant", "Arcanophage", "Arcanopulser", "Earth Warrior", "Electrokinetic", "Elemontalist", "Flame Warrior", "Geomancer", "Martial Elementalist", "Metal Warrior", "Natural Warrior", "Soul Adept", "Tenebrous Stalker", "Twinsoul Elementalist", "Water Warrior", "Wind Warrior"]
#
,
'eliciter': ["Dark Presence","Empathic Duelist","Fright Wright","Hypnotist","Id","Sympath"]
#
,
'hedgewitch':["Dreamtwister","Seelie Disciple","Sidhe Invoker","Skulk","Solipsist","Unseelie Disciple","Word Witch","Wunderkind [WoP]"]
#
,
...
#
,
'mageknight': ["Broadcast Blade","Divine Lariat","Doomblade","Dragoon","Dread Crusader","Dustbringer","Grim Disciple","Herculean Scion","Kinetic Scourge","Knightknight","Knight-Summoner","Marshal Controller [CS]","Martial Mageknight [CS]","Plaguebringer","Resizer","Sun Warrior","Utterdark Champion","Wardmage","Warrior of Holy Light"]
#
,
'shifter': ["ApexShifter","Beastlord","Beastmind","DimensionShifter","ElementalScion","FamineSpirit","FeyIncarnate","ForcefulShifter","MartialShifter[CS]","NocturnalPredator","PackMaster","Paragon[CS]","Protean","RadiantProtean","Spellvampire"]
#
,
'soul weaver':["Banshee", "CycleWatcher", "DualChanneler", "GhostSovereign", "Lichling", "Pharmakon", "Shaman[WoP]", "ShepherdoftheLost", "Totemist"]
#
,
'symbiat': ["Battlemind[CS]","Bloodscarred","Champion Symbiat[CS]","Chronomancer","Egregore","Gravecrawler","Hekatonkheires","Invidian","Malefactor","Mistwalker","Operative","Synapse","Technopath[3PP]","Telekinetic Warrior","Vector[CS]","Warmonger"]
#
,
'thamaturge': ["Banshee", "CycleWatcher", "DualChanneler", "GhostSovereign", "Lichling", "Pharmakon", "Shaman [WoP]", "ShepherdOfTheLost", "Totemist", "Battlemind [CS]", "Bloodscarred", "ChampionSymbiat [CS]", "Chronomancer", "Egregore", "Gravecrawler", "Hekatonkheires", "Invidian", "Malefactor", "Mistwalker", "Operative", "Synapse", "Technopath [3PP]", "TelekineticWarrior", "Vector [CS]", "Warmonger", "Devourer", "EldritchCultist", "Experimentalist", "Gambler [CS/3PP]", "KnightOfWillpower", "MartialThaumaturge [CS]", "PactMaster", "Pactmage", "Savant", "SoulfireMaster", "UnseenHorror", "VoidGazer", "WildMage"]
#
,
'wraith': ["BaobhanSith","Collective[CS]","Draugr[CS]","Matagot[CS,CatgirlHB]","Mistshade","Swarmheart","Unbodied"]
#
,
#spheres of power agents
'agent': ['Blackpowder Slayer', 'Erudie Pugilist', 'Imposter', 'Superstar Spy']
#
,
'courser': ["Gourmand", "Nomad", "Ravener"]
#
,
'envoy': ["Aristarch", "Idol", "Luminary"]
#
,
'mastermind': ['Saboteur', 'Squad Operator']
#
,
'professional': ['Trader']
}
