...
classes = {
    'Barbarian': {
        ...
        'armor': ['Padded', 'Leather', 'Studded Leather', 'Hide', 'Chain Shirt', 'Scalemail', 'Breastplate', 'Halfplate'],
    ...
    'Fighter': {
        'weapons': ['Club', 'Dagger', 'Quarterstaff', 'Scimitar', 'Sickle', 'Shortspear', 'Sling', 'Longspear', 'Battleaxe', 'Greatsword', 'Greataxe', 'Warhammer', 'Lance', 'Longsword'],
        'armor': ['Padded', 'Leather', 'Studded Leather', 'Hide', 'Chain Shirt', 'Scalemail', 'Breastplate', 'Halfplate', 'Ringmail', 'Chainmail', 'Splint', 'Plate'],
...
mannerisms = ['Prone To Singing Or Whistling', 'Loves To Rhyme', 'Slurs Words', 'Enuciates Clearly', 'Speaks Loudly', 'Whispers', 'Comedian', 'Bites Fingernails', 'Taps Fingers']
